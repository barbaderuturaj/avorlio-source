...
export const guide: Guide = {
  ...
  sections: [
    ...
    },
    {
      ...
      callout: {
        kind: "analogy",
        text: "A *sub-account* is basically a separate mini-office inside your GoHighLevel account, one per client — you set it up once, then rebill it under your own logo instead of the client ever seeing GoHighLevel's name."
      },
      diagram: {
        type: "compare",
        title: "Do you need the full platform?",
        left: {
          heading: "You need GoHighLevel",
          items: ["Running real funnels + paid traffic", "Ongoing email/SMS campaigns", "Reselling to clients via sub-accounts"]
        },
        right: {
          heading: "You're overbuying",
          items: ["Success = phone answered, not funnels", "Features you're not sure you'll ever open", "Paying for capacity you won't use"]
        }
      }
    },
    {
