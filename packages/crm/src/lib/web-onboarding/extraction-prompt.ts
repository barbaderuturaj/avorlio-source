...
- emergency_service: boolean (true only if the site explicitly says emergency availability such as 24/7 emergency service, after-hours service, nights/weekends on-call service, or emergency dispatch. A service name like "Emergency plumbing" alone is just a service category and does NOT prove 24/7/on-call/immediate availability.)
...
- certifications: string[] (e.g. ["licensed", "bonded", "insured", "BBB A+"])
- trust_signals: string[] (e.g. ["family-owned since 1998", "satisfaction guaranteed"])
- emergency_service: boolean (true only if Markdown explicitly says emergency availability such as 24/7 emergency service, after-hours service, nights/weekends on-call service, or emergency dispatch. A service name like "Emergency plumbing" alone is just a service category and does NOT prove 24/7/on-call/immediate availability.)
